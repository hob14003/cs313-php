  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="viewCart.php">View Cart<span class="sr-only">(current)</span></a>
      </li>
    </ul>
  </div>
</nav>
                        ...
                        foreach ($cart as $item) {
                            switch ($item) {
                                        case "H":
                                            ...
                                            echo '<td>$2.59</td>';
                                            echo '<td><input type="submit" name="remove[]" value="Remove H" class="btn btn-dark"></td></tr>';
                                            $total += 2.59;
                                            break;
                                        case "He":
                                            ...
                                            echo '<td>$0.19</td>';
                                            echo '<td><input type="submit" name="remove[]" value="Remove He" class="btn btn-dark"></td></tr>';
                                            $total += 0.19;
                                            break;
                                    ...
                                    case "Li":
                                            ...
                                            echo '<td>$7.99</td>';
                                            echo '<td><input type="submit" name="remove[]" value="Remove Li" class="btn btn-dark"></td></tr>';
                                            $total += 7.99;
                                            break;
                                        case "Be":
                                            ...
                                            echo '<td>$8.59</td>';
                                            echo '<td><input type="submit" name="remove[]" value="Remove Be" class="btn btn-dark"></td></tr>';
                                            $total += 8.59;
                                            break;
                                        case "Si":
                                            ...
                                            echo '<td>$3.59</td>';
                                            echo '<td><input type="submit" name="remove[]" value="Remove Si" class="btn btn-dark"></td></tr>';
                                            $total += 3.59;
                                            break;
                                        case "Zr":
                                            ...
                                            echo '<td>$5.07</td>';
                                            echo '<td><input type="submit" name="remove[]" value="Remove Zr" class="btn btn-dark"></td></tr>';
                                            $total += 5.07;
                                            break;
                                        case "Ba":
                                            ...
                                            echo '<td>$11.42</td>';
                                            echo '<td><input type="submit" name="remove[]" value="Remove Ba" class="btn btn-dark"></td></tr>';
                                            $total += 11.42;
                                            break;
                                        case "Tb":
                                            ...
                                            echo '<td>$56.78</td>';
                                            echo '<td><input type="submit" name="remove[]" value="Remove Tb" class="btn btn-dark"></td></tr>';
                                            $total += 56.78;
                                            break;
                                        case "Lu":
                                            ...
                                            echo '<td>$97.12</td>';
                                            echo '<td><input type="submit" name="remove[]" value="Remove Lu" class="btn btn-dark"></td></tr>';
                                            $total += 97.12;
                                            break;
                                }                                    
                            } //foreach close
                        echo "<tr><td></td><td></td><td>Total: $$total</td><td></td>
                        <tr><td></td><td><a href=\"browse.php\" class=\"btn btn-dark\">Continue Shopping</a></td><td><a href=\"checkout.php\" class=\"btn btn-dark pull-right\">Checkout</a></td><td></td>
                        </table>
                        </form>";
                        } else {
