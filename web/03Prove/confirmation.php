...
$addressDirty = $_POST["address"];
$address = filter_var($addressDirty, FILTER_SANITIZE_STRING);
?>
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    ...
    <?php
                    ...
                    if($cartCount != 0) {
                        ...
                        <tr><td></td><td></td><td><a href=\"browse.php\" class=\"btn btn-dark\">Continue Shopping</a></td>

                        
                        </table>
                        <h4>Purchase successful! We will ship your order to $address today. For additional purchases, please click the Continue Shopping button above</h4>
                        </form>";
                        } else {
